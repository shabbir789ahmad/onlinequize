    ...
    <nav class="navbar_list" style="overflow:hidden;">
      ...
      <ul class="ul mb-0">
        ...
        <li class="li"><a href="{{route('lifeline.create')}}"   class="  {{ (request()->is('lifeline/create')) ? 'active' : '' }}">Life Line</a></li>
...
<img src="{{asset('img/avatars/download.png')}}" width="100%" class=" dropdown-toggle user_image" data-bs-toggle="dropdown" aria-expanded="false">
  <ul class="dropdown-menu">
     <li><a class="dropdown-item" href="{{route('payouts')}}">Dashboard</a></li>
